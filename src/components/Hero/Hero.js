...
const Hero = () => {
    const backgroundStyle = {
        backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(15, 20, 32, 0.79) 100%), url("${process.env.PUBLIC_URL}/assets/images/hero.webp")`,
    };
    ...
    return (
        <section className="hero" style={backgroundStyle}>
            ...
            <img src={`${process.env.PUBLIC_URL}/assets/images/earth.webp`} alt="Earth" className="hero__image"/>
        </section>
    )
};
